...
GD.PART_TREES.crx = {
  ...
  diagnosticScenarios: [
    { id: "crx_diag_misfire", symptom: "Rough idle and stumble under light throttle. Worse when cold, improves when hot.",
      ...
      multiLayer: null },
    { id: "crx_diag_overheat", symptom: "Temp gauge spikes to red in traffic. Fan kicks on but car still overheats.",
      ...
      multiLayer: null },
    { id: "crx_diag_clutch_slip", symptom: "RPMs flare during hard acceleration but the car doesn't accelerate proportionally.",
      ...
      multiLayer: null },
    { id: "crx_diag_brake_pull", symptom: "Car pulls hard to the right under braking. Steering wheel tugs.",
...
GD.PART_TREES.s13 = {
  ...
  diagnosticScenarios: [
    { id: "s13_diag_timing", symptom: "Startup rattle that goes away after 30 seconds. Worse when oil is cold.",
      ...
      multiLayer: null },
    { id: "s13_diag_fuel_lean", symptom: "Engine stumbles at WOT above 4000 RPM. Fine at part throttle.",
      ...
      multiLayer: null },
    { id: "s13_diag_rear_clunk", symptom: "Clunk from the rear under deceleration and direction changes.",
      ...
      multiLayer: null },
    { id: "s13_diag_misfire_idle", symptom: "Rough idle and CEL. Occasional stumble when pulling away from stops.",
...
GD.PART_TREES.fc3s = {
  ...
  diagnosticScenarios: [
    { id: "fc_diag_apex_seals", symptom: "Cold start smoke, low compression on one chamber, and a burning-sweet smell at idle.",
      ...
      multiLayer: null },
    { id: "fc_diag_coolant_seal", symptom: "White steam from the exhaust. Coolant level drops. Engine does not overheat.",
      ...
      multiLayer: null },
    { id: "fc_diag_boost", symptom: "Boost pressure doesn't build above 5 PSI. Power feels like a naturally aspirated car.",
      ...
      multiLayer: null },
    { id: "fc_diag_turbo_worn", symptom: "Black smoke under boost, oil consumption, and slight turbo shaft play.",
      ...
      multiLayer: null },
    { id: "fc_diag_oil_leak", symptom: "Oil weeping from the front of the engine. Burning oil smell after warmup.",
